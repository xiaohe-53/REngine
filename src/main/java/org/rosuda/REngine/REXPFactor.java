...
/** org.rosuda.REngine.REXPFactor represents a factor in R. It is an integer vector with levels for each contained category. */
// FIXME: this is currently somehow screwed - the concept of org.rosuda.REngine.RFactor and org.rosuda.REngine.REXPFactor is duplicate - we need to remove this historical baggage
public class REXPFactor extends REXPInteger {
	private String[] levels;
	private RFactor factor;
	
	/** create a new factor org.rosuda.REngine.REXP
	...
	/** create a new factor org.rosuda.REngine.REXP from an existing org.rosuda.REngine.RFactor

...
/**
 * Utility class to wrap an Object into a org.rosuda.REngine.REXP object.
 *
 * This facilitates wrapping native java objects and arrays 
 * into org.rosuda.REngine.REXP objects that can be pushed to R
 *
...
public class REXPWrapper {
	...
	/**
	 * Wraps an Object into a org.rosuda.REngine.REXP
	 *
	 * <p>Conversion :</p>
	 *
	 * <ul>
	 * <li>Byte (byte) : org.rosuda.REngine.REXPRaw </li>
	 * <li>Short (short) : org.rosuda.REngine.REXPInteger </li>
	 * <li>Integer (int) : org.rosuda.REngine.REXPInteger </li>
	 * <li>Long (long) : org.rosuda.REngine.REXPInteger</li>
	 * <li>Float (float) : org.rosuda.REngine.REXPDouble</li>
	 * <li>Double (double) : org.rosuda.REngine.REXPDouble </li>
	 * <li>Boolean (boolean) : org.rosuda.REngine.REXPLogical</li>
	 * <li>--</li>
	 * <li>String : org.rosuda.REngine.REXPString </li>
	 * <li>String[] : org.rosuda.REngine.REXPString </li>
	 * <li>--</li>
	 * <li>byte[] or Byte[] : org.rosuda.REngine.REXPRaw</li>
	 * <li>short[] or Short[] : org.rosuda.REngine.REXPInteger</li>
	 * <li>int[] or Integer[] : org.rosuda.REngine.REXPInteger</li>
	 * <li>long[] or Long[] : org.rosuda.REngine.REXPInteger</li>
	 * <li>float[] or Float[] : org.rosuda.REngine.REXPDouble</li>
	 * <li>double[] or Double[] : org.rosuda.REngine.REXPDouble </li>
	 * <li>boolean[] or Boolean[]: org.rosuda.REngine.REXPLogical</li>
	 * <li>--</li>
	 * <li>null for anything else</li>
	 * </ul>
	 * 
	 * @param o object to wrap
	 * @return org.rosuda.REngine.REXP object that represents o or null if the conversion is not possible
	 */
	public static REXP wrap( Object o ) {
		...
		/* Strings -> org.rosuda.REngine.REXPString */
		...
		/* array of byte or Bytes -> org.rosuda.REngine.REXPRaw */
		...
		/* arrays of short or Short  -> org.rosuda.REngine.REXPInteger */
		...
		/* arrays of int or Integer ->  org.rosuda.REngine.REXPInteger */
		...
		/* arrays of long or Long -> org.rosuda.REngine.REXPInteger */
		...
		/* float or Float arrays -> org.rosuda.REngine.REXPDouble */
		...
		/* double or Double arrays -> org.rosuda.REngine.REXPDouble */
		...
		/* boolean arrays -> org.rosuda.REngine.REXPLogical */

...
/** Represents a pairlist in R. Unlike the actual internal R implementation this one
    does not use CAR/CDR/TAG linked representation but a @link{org.rosuda.REngine.RList} object. */
public class REXPList extends REXPVector {
	...
	public Object asNativeJavaObject() throws REXPMismatchException {
		// since org.rosuda.REngine.REXPGenericVector does the hard work, we just cheat and use it in turn

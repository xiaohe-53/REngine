package org.rosuda.REngine;// org.rosuda.REngine.REngine
...
/** representation of a factor variable. In R there is no actual object
    ...
    attribute. The parser code of org.rosuda.REngine.REXP converts such constructs directly into
    the org.rosuda.REngine.RFactor objects and defines an own XT_FACTOR type
...
public class RFactor {
	...
	/** same as <code>org.rosuda.REngine.RFactor(c, 1)</code> */
	public RFactor(String c[]) {
		this(c, 1);
	}
	
	/** same as <code>org.rosuda.REngine.RFactor(i,v, true, 1)</code> */

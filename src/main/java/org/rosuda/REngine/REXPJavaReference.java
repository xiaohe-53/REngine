...
/** org.rosuda.REngine.REXPJavaReference is a reference to a Java object that has been resolved from is R wrapper. Note that not all engines support references. */
public class REXPJavaReference extends REXP {
	/** the referenced Java object */
	Object object;

	/** creates a new Java reference R object
	 *  @param o Java object referenced by the org.rosuda.REngine.REXP */
	...
	/** returns the Java object referenced by this org.rosuda.REngine.REXP
	 *  @return Java object */

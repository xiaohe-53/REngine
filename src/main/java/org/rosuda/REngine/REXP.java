...
public class REXP implements Serializable {
	...
	/** public root contrsuctor, same as <tt>new org.rosuda.REngine.REXP(null)</tt> */
	public REXP() { }
	...
	/** check whether the <code>org.rosuda.REngine.REXP</code> object is a language object
	...
	/** check whether the <code>org.rosuda.REngine.REXP</code> object is an expression vector
	...
	/** check whether the <code>org.rosuda.REngine.REXP</code> object is a symbol
	 @return <code>true</code> if the receiver is a symbol, <code>false</code> otherwise */
	public boolean isSymbol() { return false; }
	/** check whether the <code>org.rosuda.REngine.REXP</code> object is a vector
	 @return <code>true</code> if the receiver is a vector, <code>false</code> otherwise */
	public boolean isVector() { return false; }
	/** check whether the <code>org.rosuda.REngine.REXP</code> object is a raw vector
	 @return <code>true</code> if the receiver is a raw vector, <code>false</code> otherwise */
	public boolean isRaw() { return false; }
	/** check whether the <code>org.rosuda.REngine.REXP</code> object is a complex vector
	 @return <code>true</code> if the receiver is a complex vector, <code>false</code> otherwise */
	public boolean isComplex() { return false; }
	/** check whether the <code>org.rosuda.REngine.REXP</code> object is a recursive obejct
	...
	/** check whether the <code>org.rosuda.REngine.REXP</code> object is a reference to an R object
	...
	/** this method allows a limited access to object's attributes - <b>{@link #getAttribute} should be used instead to access specific attributes</b>!. Note that the {@link #attr} attribute should never be used directly incase the org.rosuda.REngine.REXP implements a lazy access (e.g. via a reference)
	...
	/** returns the content of the org.rosuda.REngine.REXP as a matrix of doubles (2D-array: m[rows][cols]). This is the same form as used by popular math packages for Java, such as JAMA. This means that following leads to desired results:<br>
	...
	/** creates a org.rosuda.REngine.REXP that represents a double matrix in R based on matrix of doubles (2D-array: m[rows][cols]). This is the same form as used by popular math packages for Java, such as JAMA. The result of this function can be used in {@link REngine.assign} to store a matrix in R.
	 @param matrix array <code>double[rows][colums]</code> containing the matrix to convert into a org.rosuda.REngine.REXP. If <code>matrix</code> is <code>null</code> or either of the dimensions is 0 then the resulting matrix will have the dimensions <code>0 x 0</code> (Note: Java cannot represent <code>0 x n</code> matrices for <code>n &gt; 0</code>, so special matrices with one dimension of 0 can only be created by setting dimensions directly).
	 @return <code>org.rosuda.REngine.REXPDouble</code> with "dim" attribute which constitutes a matrix in R */
